...
#include <Rtypes.h>
      ...
      class TrackParBase { // track parameterization, kinematics only. This base class cannot be instantiated
        public:
          ...
          // derived getters
          float GetCurvature(float b)          const { return mP[kQ2Pt]*b*o2::Base::Constants::kB2C;}
      ...
      inline void TrackParBase::GetXYZ(std::array<float,3> &xyz) const {
        ...
        xyz[1] = GetY();
        xyz[2] = GetZ();
        o2::Base::Utils::RotateZ(xyz,GetAlpha());
      }
      ...
      inline float TrackParBase::GetP() const {
        ...
        return (ptI>o2::Base::Constants::kAlmost0) ? sqrtf(1.f+ GetTgl()*GetTgl())/ptI : o2::Base::Constants::kVeryBig;
      }
      ...
      inline float TrackParBase::GetPt() const {
        ...
        float ptI = fabs(GetQ2Pt());
        return (ptI>o2::Base::Constants::kAlmost0) ? 1.f/ptI : o2::Base::Constants::kVeryBig;
      }
