...
ClassImp(TrackParBase)
ClassImp(TrackParCov)
ClassImp(TrackPar)
  ...
  mX{0.f},mAlpha{0.f},mP{0.f}
{
  ...
  if (sectorAlpha) alp = Utils::Angle2Alpha(alp);
  //
  float sn,cs;
...
//____________________________________________________
float BetheBlochSolid(float bg, float rho,float kp1,float kp2,float meanI,float meanZA)
{
  //
